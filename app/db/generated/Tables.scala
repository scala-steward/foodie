...
trait Tables {
  ...
  lazy val schema: profile.SchemaDescription = Array(ComplexFood.schema, ComplexIngredient.schema, ConversionFactor.schema, FoodGroup.schema, FoodName.schema, FoodSource.schema, Meal.schema, MealEntry.schema, MeasureName.schema, NutrientAmount.schema, NutrientName.schema, NutrientSource.schema, Profile.schema, Recipe.schema,
  ...
  class ComplexFood(_tableTag: Tag) extends profile.api.Table[ComplexFoodRow](_tableTag, "complex_food") {
    ...
    lazy val recipeFk = foreignKey("complex_food_user_id_recipe_id_fk", (userId, recipeId), Recipe)(
      r => (r.userId, r.id),
    ...
    lazy val userFk = foreignKey("complex_food_user_id_fk", userId, User)(
      r => r.id,
      onUpdate = ForeignKeyAction.NoAction,
      onDelete = ForeignKeyAction.Cascade
    )
  ...
  class ComplexIngredient(_tableTag: Tag)
    ...
    lazy val complexFoodFk = foreignKey(
      "complex_ingredient_user_id_complex_food_id_fk",
      (userId, complexFoodId),
      ComplexFood
    )(r => (r.userId, r.recipeId), onUpdate = ForeignKeyAction.NoAction, onDelete = ForeignKeyAction.Cascade)

    /** Foreign key referencing Recipe (database name complex_ingredient_user_id_recipe_id_fk) */
    lazy val recipeFk = foreignKey("complex_ingredient_user_id_recipe_id_fk", (userId, recipeId), Recipe)(
      r => (r.userId, r.id),
      onUpdate = ForeignKeyAction.NoAction,
      onDelete = ForeignKeyAction.Cascade
    )
    ...
    lazy val userFk = foreignKey("complex_ingredient_user_id_fk", userId, User)(
      r => r.id,
      onUpdate = ForeignKeyAction.NoAction,
      onDelete = ForeignKeyAction.Cascade
    )
  ...
  class MealEntry(_tableTag: Tag) extends profile.api.Table[MealEntryRow](_tableTag, "meal_entry") {
    ...
    lazy val recipeFk = foreignKey("meal_entry_user_id_recipe_id_fk", (userId, recipeId), Recipe)(
      r => (r.userId, r.id),
      onUpdate = ForeignKeyAction.NoAction,
      onDelete = ForeignKeyAction.Cascade
    )
    ...
    lazy val userFk = foreignKey("meal_entry_user_id_fk", userId, User)(
      r => r.id,
      onUpdate = ForeignKeyAction.NoAction,
      onDelete = ForeignKeyAction.Cascade
    )
  ...
  class RecipeIngredient(_tableTag: Tag)
    ...
    lazy val recipeFk = foreignKey("recipe_ingredient_user_id_recipe_id_fk", (userId, recipeId), Recipe)(
      r => (r.userId, r.id),
      onUpdate = ForeignKeyAction.NoAction,
      onDelete = ForeignKeyAction.Cascade
    )
    ...
    lazy val userFk = foreignKey("recipe_ingredient_user_id_fk", userId, User)(
      r => r.id,
      onUpdate = ForeignKeyAction.NoAction,
      onDelete = ForeignKeyAction.Cascade
    )
  ...
  /** Entity class storing rows of table ReferenceEntry
    ...
    *   Database column user_id SqlType(uuid)
    */
  case class ReferenceEntryRow(
      referenceMapId: java.util.UUID,
      nutrientCode: Int,
  ...
  class ReferenceEntry(_tableTag: Tag) extends profile.api.Table[ReferenceEntryRow](_tableTag, "reference_entry") {
    ...
    lazy val referenceMapFk = foreignKey(
      "reference_entry_user_id_reference_map_id_fk",
      (userId, referenceMapId),
      ReferenceMap
    )(r => (r.userId, r.id), onUpdate = ForeignKeyAction.NoAction, onDelete = ForeignKeyAction.Cascade)

    /** Foreign key referencing User (database name reference_entry_user_id_fk) */
    lazy val userFk = foreignKey("reference_entry_user_id_fk", userId, User)(
      r => r.id,
      onUpdate = ForeignKeyAction.NoAction,
      onDelete = ForeignKeyAction.Cascade
    )

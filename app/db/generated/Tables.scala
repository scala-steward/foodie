...
trait Tables {
  ...
  class ComplexFood(_tableTag: Tag) extends profile.api.Table[ComplexFoodRow](_tableTag, "complex_food") {
    ...
    def ? =
      ((Rep.Some(recipeId), Rep.Some(amountGrams), amountMilliLitres)).shaped.<>(
  ...
  class ComplexIngredient(_tableTag: Tag)
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      ((Rep.Some(recipeId), Rep.Some(complexFoodId), Rep.Some(factor))).shaped.<>(
  ...
  implicit def GetResultFoodGroupRow(implicit e0: GR[Int], e1: GR[Option[String]]): GR[FoodGroupRow] =
    GR { prs =>
      import prs._
  ...
  class FoodGroup(_tableTag: Tag) extends profile.api.Table[FoodGroupRow](_tableTag, Some("cnf"), "food_group") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      ((Rep.Some(foodGroupId), foodGroupCode, foodGroupName, foodGroupNameF)).shaped.<>(
  ...
  implicit def GetResultFoodSourceRow(implicit e0: GR[Int], e1: GR[Option[String]]): GR[FoodSourceRow] =
    GR { prs =>
      import prs._
  ...
  class Meal(_tableTag: Tag) extends profile.api.Table[MealRow](_tableTag, "meal") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      ((Rep.Some(id), Rep.Some(userId), Rep.Some(consumedOnDate), consumedOnTime, name)).shaped.<>(
  ...
  class MealEntry(_tableTag: Tag) extends profile.api.Table[MealEntryRow](_tableTag, "meal_entry") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      ((Rep.Some(id), Rep.Some(mealId), Rep.Some(recipeId), Rep.Some(numberOfServings))).shaped.<>(
  ...
  implicit def GetResultMeasureNameRow(implicit e0: GR[Int], e1: GR[String]): GR[MeasureNameRow] =
    GR { prs =>
      import prs._
  ...
  class MeasureName(_tableTag: Tag) extends profile.api.Table[MeasureNameRow](_tableTag, Some("cnf"), "measure_name") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      ((Rep.Some(measureId), Rep.Some(measureDescription), Rep.Some(measureDescriptionF))).shaped.<>(
  ...
  implicit
  def GetResultNutrientNameRow(implicit e0: GR[Int], e1: GR[String], e2: GR[Option[String]]): GR[NutrientNameRow] =
    GR { prs =>
      import prs._
  ...
  implicit def GetResultNutrientSourceRow(implicit e0: GR[Int], e1: GR[Option[String]]): GR[NutrientSourceRow] =
    GR { prs =>
      import prs._
  ...
  class RecipeIngredient(_tableTag: Tag)
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      ((Rep.Some(id), Rep.Some(recipeId), Rep.Some(foodNameId), measureId, Rep.Some(factor))).shaped.<>(
  ...
  class ReferenceEntry(_tableTag: Tag) extends profile.api.Table[ReferenceEntryRow](_tableTag, "reference_entry") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      ((Rep.Some(referenceMapId), Rep.Some(nutrientCode), Rep.Some(amount))).shaped.<>(
  ...
  implicit def GetResultReferenceMapRow(implicit e0: GR[java.util.UUID], e1: GR[String]): GR[ReferenceMapRow] =
    GR { prs =>
      import prs._
  ...
  class ReferenceMap(_tableTag: Tag) extends profile.api.Table[ReferenceMapRow](_tableTag, "reference_map") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      ((Rep.Some(id), Rep.Some(name), Rep.Some(userId))).shaped.<>(
  ...
  implicit def GetResultRefuseAmountRow(implicit e0: GR[Int], e1: GR[java.sql.Date]): GR[RefuseAmountRow] =
    GR { prs =>
      import prs._
  ...
  class RefuseAmount(_tableTag: Tag)
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      ((Rep.Some(foodId), Rep.Some(refuseId), Rep.Some(refuseAmount), Rep.Some(refuseDateOfEntry))).shaped.<>(
  ...
  implicit def GetResultRefuseNameRow(implicit e0: GR[Int], e1: GR[String]): GR[RefuseNameRow] =
    GR { prs =>
      import prs._
  ...
  class RefuseName(_tableTag: Tag) extends profile.api.Table[RefuseNameRow](_tableTag, Some("cnf"), "refuse_name") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      ((Rep.Some(refuseId), Rep.Some(refuseDescription), Rep.Some(refuseDescriptionF))).shaped.<>(
  ...
  implicit def GetResultSessionRow(implicit e0: GR[java.util.UUID]): GR[SessionRow] =
    GR { prs =>
      import prs._
  ...
  class Session(_tableTag: Tag) extends profile.api.Table[SessionRow](_tableTag, "session") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      ((Rep.Some(id), Rep.Some(userId))).shaped.<>(
        { r => import r._; _1.map(_ => SessionRow.tupled((_1.get, _2.get))) },
        (_: Any) => throw new Exception("Inserting into ? projection not supported.")
      )
  ...
  implicit def GetResultYieldAmountRow(implicit e0: GR[Int], e1: GR[java.sql.Date]): GR[YieldAmountRow] =
    GR { prs =>
      import prs._
  ...
  class YieldAmount(_tableTag: Tag) extends profile.api.Table[YieldAmountRow](_tableTag, Some("cnf"), "yield_amount") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      ((Rep.Some(foodId), Rep.Some(yieldId), Rep.Some(yieldAmount), Rep.Some(yieldDateOfEntry))).shaped.<>(
  ...
  implicit def GetResultYieldNameRow(implicit e0: GR[Int], e1: GR[String]): GR[YieldNameRow] =
    GR { prs =>
      import prs._
  ...
  class YieldName(_tableTag: Tag) extends profile.api.Table[YieldNameRow](_tableTag, Some("cnf"), "yield_name") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      ((Rep.Some(yieldId), Rep.Some(yieldDescription), Rep.Some(yieldDescriptionF))).shaped.<>(

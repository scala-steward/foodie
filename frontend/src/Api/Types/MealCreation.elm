...
type alias MealCreation =
    { date : SimpleDate, name : Maybe String }


decoderMealCreation : Decode.Decoder MealCreation
decoderMealCreation =
    Decode.succeed MealCreation |> required "date" (Decode.lazy (\_ -> decoderSimpleDate)) |> optional "name" (Decode.maybe Decode.string) Nothing


encoderMealCreation : MealCreation -> Encode.Value
encoderMealCreation obj =

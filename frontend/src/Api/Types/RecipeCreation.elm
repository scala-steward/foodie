...
decoderRecipeCreation =
    Decode.succeed RecipeCreation |> required "name" Decode.string |> optional "description" (Decode.maybe Decode.string) Nothing |> required "numberOfServings" Decode.float |> optional "servingSize" (Decode.maybe Decode.string) Nothing


encoderRecipeCreation : RecipeCreation -> Encode.Value
encoderRecipeCreation obj =

...
decoderPasswordChangeRequest =
    Decode.succeed PasswordChangeRequest |> required "password" Decode.string


encoderPasswordChangeRequest : PasswordChangeRequest -> Encode.Value
encoderPasswordChangeRequest obj =
    Encode.object [ ( "password", Encode.string obj.password ) ]

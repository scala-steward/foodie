...
decoderRecoveryRequest =
    Decode.succeed RecoveryRequest |> required "userId" Uuid.decoder


encoderRecoveryRequest : RecoveryRequest -> Encode.Value
encoderRecoveryRequest obj =
    Encode.object [ ( "userId", Uuid.encode obj.userId ) ]
